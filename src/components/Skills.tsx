          ...
          {Array.from({ length: 8 }).map((_, index) => (
            <motion.span
              ...
              className="
                ...
                sm:h-2
                sm:w-2
                sm:shadow-[0_0_15px_rgba(168,85,247,0.9)]
              "
              style={{
                transform: `rotate(${index * 45}deg) translateX(var(--orbit-radius))`,
              }}
              ...
              >
                ...
                <div
                  className="
                    ...
                    dark:hover:shadow-[0_0_30px_rgba(139,92,246,0.3)]
                    sm:gap-2
                    sm:rounded-xl
                    sm:px-3
                    sm:py-2.5
            ...
            >
              ...
              <div
                className="
                  ...
                  group-hover:bg-purple-500/[0.03]
                  dark:border-white/10
                  dark:bg-white/[0.025]
                  dark:shadow-none
                  dark:group-hover:border-purple-400/30
